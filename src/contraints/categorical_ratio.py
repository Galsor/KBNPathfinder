...
class FlexibleCategoricalRatioConstraint(BaseConstraint):
    ...
    def __init__(self, property_name: str, objectives: Dict[Any, float], graph: KBNGraph, k: int):
        self.property_name = property_name
        self.objectives = objectives
        self.objectives_counts = {cat: int(obj*k) for cat, obj in self.objectives.items()}
        self.k = k
    ...
    def completion_state(self) -> Dict[str, float]:
        return {
            ...
            if self.objectives_counts[cat] != 0 else 1.0
